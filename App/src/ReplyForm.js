...
class ReplyForm extends Component {
  ...
  handleInputChange(event) {
    this.setState({
      replyString: event.target.value,
      tweetor: this.props.address,
  ...
  render() {
    ...
    // console.log(this.props, 'RF REPLY');
...
export default drizzleConnect(ReplyForm, mapStateToProps);
